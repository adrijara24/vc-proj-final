...
\textbf{Alternatives Descartades}: Durant la fase de disseny, es van avaluar, implementar i descartar l'altraestratègies tradicionals per alinear les matrícules. La taula \ref{preproc_ALIGN} resumeix els motius pels quals es va abandonar a favor de l'enfocament actual.
